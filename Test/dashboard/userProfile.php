                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Username" ng-model="username" disabled required>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control"  ng-model="postalnumber" >
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea rows="5" class="form-control" placeholder="Here can be your description"  ng-model="aboutme" ></textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="content">
                                <div class="author">
                                    ...
                                    <img class="avatar border-gray" src="assets/img/default-avatar.png"   />
                                      ...
                                      <h4 class="title"><br />
                                         <small><input #file type="file" accept='image/*' (change)="preview(file.files)" /></small>
                                      </h4>
